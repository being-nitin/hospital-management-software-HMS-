    ...
    const adminLinks = () => {
        return (
            <Fragment>
                ...
                <Link className="nav-link" style={isActive(location, '/calendar')} to='/calendar'>
                ...
                <div className="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                    <nav className="sb-sidenav-menu-nested nav">
                        <Link className="nav-link" style={isActive(location, '/list-cat-test')} to="/list-cat-test">Category Test</Link>
                        <Link className="nav-link" style={isActive(location, '/test-result')} to="/test-result">Tests Result</Link>
                    </nav>
                </div>
                ...
                <div className="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
                    <nav className="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                        ...
                        <div className="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                            <nav className="sb-sidenav-menu-nested nav">
                                <Link className="nav-link" style={isActive(location, '/list-treat-cat')} to="/list-treat-cat">Treatment</Link>
                                <Link className="nav-link" style={isActive(location, '/list-prescriptions')} to="/list-prescriptions">Prescription List</Link>
                            </nav>
                        </div>
                        ...
                        <div className="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                            <nav className="sb-sidenav-menu-nested nav">
                                <Link className="nav-link" style={isActive(location, '/list-buildings')} to="/list-buildings">Building</Link>
                                <Link className="nav-link" style={isActive(location, '/list-floors')} to="/list-floors">Floors</Link>
                                <Link className="nav-link" style={isActive(location, '/list-departs')} to="/list-departs">Department</Link>
                            </nav>
                        </div>
                    </nav>
                </div>
                ...
                <Link className="nav-link" style={isActive(location, '/list-patients')} to="/list-patients">
                    <div className="sb-nav-link-icon"><i className="bi bi-file-medical" /></div>
                    Patients
                </Link>

                <Link className="nav-link" style={isActive(location, '/list-doctors')} to="/list-doctors">
                    <div className="sb-nav-link-icon"><i className="bi bi-file-medical" /></div>
                    Doctors
                </Link>
                ...
                <Link className="nav-link" style={isActive(location, '/list-vendors')} to="/list-vendors">
                    <div className="sb-nav-link-icon"><i className="bi bi-shop" /></div>
                    Vendors
                </Link>

                <Link className="nav-link" style={isActive(location, '/list/medicine')} to="/list/medicine">
                    <div className="sb-nav-link-icon"></div>
                    Medicine
                </Link>

                <div className="sb-sidenav-menu-heading">Expenses</div>
                <Link className="nav-link" style={isActive(location, '/list-expenses')} to="/list-expenses">
                    <div className="sb-nav-link-icon"><i className="bi bi-cash" /></div>
                    Expenses
                </Link>

                <div className="sb-sidenav-menu-heading">Vaccine</div>
                <Link className="nav-link" style={isActive(location, '/list-vaccine-cat')} to="/list-vaccine-cat">
                    <div className="sb-nav-link-icon"><i className="bi bi-eyedropper" /></div>
                    Vaccine
                </Link>

                <Link className="nav-link" style={isActive(location, '/list-app-vaccine')} to="/list-app-vaccine">
                ...
                <Link className="nav-link" style={isActive(location, '/list-designate')} to="/list-designate">
                    <div className="sb-nav-link-icon"><i className="bi bi-journal-medical" /></div>
                    Designation
                </Link>

                <Link className="nav-link" style={isActive(location, '/list-specialize')} to="/list-specialize">
                    <div className="sb-nav-link-icon"><i className="bi bi-journal-medical" /></div>
                    Specialize
                </Link>
            </Fragment>
                ...
                <div id="layoutSidenav_nav">
                    <nav className="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                        <div className="sb-sidenav-menu">
                            <div className="nav">
                                {userInfo.role === 0 ? adminLinks(): userInfo.role === 1 ? doctorLinks() : staffLink()}
                            </div>
                        </div>
