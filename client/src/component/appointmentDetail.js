                ...
                <div style={styles.container}>
                  ...
                  <div style={styles.buttonContainer}>
                    ...
                    <select
                      ...
                      onChange={(e) => {
                        if (e.target.value === "HAM-A") {
                          navigate(`/HamiltonForm/${appointment._id}`);
                        }
                        if (e.target.value === "HAM-D") {
                          navigate(`/hamd/${appointment._id}`);
                        }
						if (e.target.value === "CDRS") {
							navigate(`/cdrs/${appointment._id}`);
						}
						if (e.target.value === "YMRS") {
							navigate(`/YMRS/${appointment._id}`);
						}
						if (e.target.value === "YBOCS") {
							navigate(`/ybocs/${appointment._id}`);
						}
						if (e.target.value === "PANSS") {
							navigate(`/panss/${appointment._id}`);
						}
                      }}
                    >
