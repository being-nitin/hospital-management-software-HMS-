...
const hamDData = {
    "1": {
      ...
      "options": [
        ...
        {"value": 3, "label": "Non-verbal communication (facial expression, posture, etc.)"},
        {"value": 4, "label": "Virtually only these feelings in communication"}
      ]
    },
    "2": {
      ...
      "options": [
        ...
        {"value": 4, "label": "Accusatory voices, threatening visual hallucinations"}
      ]
    },
    "3": {
      "fieldName": "Suicide",
    ...
    "6": {
      ...
      "options": [
        {"value": 0, "label": "No difficulty"},
        {"value": 1, "label": "Wakes in early morning but goes back to sleep"},
        {"value": 2, "label": "Unable to fall asleep again after getting out of bed"}
      ]
    },
    "7": {
      ...
      "options": [
        {"value": 0, "label": "No difficulty"},
        {"value": 1, "label": "Feelings of incapacity, fatigue, or weakness related to work or hobbies"},
        {"value": 2, "label": "Loss of interest in activities, hobbies, or work"},
        {"value": 3, "label": "Decreased time spent in activities or decreased productivity"},
    ...
    "10": {
      ...
      "options": [
        ...
        {"value": 3, "label": "Apprehensive attitude apparent in face or speech"},
    ...
    "12": {
      ...
      "options": [
        {"value": 0, "label": "None"},
        {"value": 1, "label": "Loss of appetite, eating without encouragement"},
        {"value": 2, "label": "Difficulty eating without urging, requires medication"}
      ]
    },
    "13": {
    ...
    "17": {
      ...
      "options": [
        ...
        {"value": 1, "label": "Acknowledges illness but attributes cause to external factors"},
    ...
    return (
      <div className="hamd-form-container">
        <form className="hamd-form" onSubmit={handleSubmit}>
          <h2 className="form-title">Hamilton Depression Rating Scale (HAM-D)</h2>
