            ...
            <div className="col-xl-3 col-md-6">
                            <div className="card bg-primary text-white mb-4">
                                ...
                                <div className="card-footer d-flex align-items-center justify-content-between">
                                    <Link className="small text-white stretched-link" to={`/list/users?role=0`}>{countAdmins()}</Link>
                        ...
                        <div className="col-xl-3 col-md-6">
                            <div className="card bg-warning text-white mb-4">
                                ...
                                <div className="card-footer d-flex align-items-center justify-content-between">
                                    <Link className="small text-white stretched-link" to={`/list/users?role=1`}>{countDoctors()}</Link>
                                    <div className="small text-white"><i className="fas fa-angle-right"/>
                                    </div>
                                </div>
                            </div>
